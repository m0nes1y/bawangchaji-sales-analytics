...
> 数据均为教学/演示用途的模拟数据，仅用于数据分析方法与实践，不代表品牌真实经营情况。
...
- **交互筛选**：支持按「城市 / 品类 / 月份（时间维度）」联动筛选，所有图表与结论实时刷新；**地图点击城市气泡可一键联动筛选全看板**
...
1. **区域表现**：营收冠军为长沙，约为末位青岛的 2.7 倍，区域差异显著，下沉市场提升空间大。
2. **产品结构**：王牌单品「伯牙绝弦」贡献约 23% 营收，是基本盘核心。
3. **季节规律**：冬季为销量旺季、秋季最低——热饮属性使冬季反超夏季。
4. **价格策略**：折扣对销量拉动有限（整体 -0.1%），且让利越多销量反而越低（让利 10% 约 298 杯 → 让利 15% 降至 238 杯），品牌定价力强，不宜盲目打折。
5. **天气影响**：高温天销量最高，阴雨/雷阵雨天气明显走低，可结合天气预报做动态排班与库存预警。
6. **节假日效应**：节假日销量较工作日低约 1.9%，自然流量红利不明显，需靠特定活动转化。
7. **会员运营**：会员占比与销量正相关（r≈0.43），提升会员拉新与复购对单店产出有正向杠杆。
8. **增长机会**：同一王牌单品在不同城市渗透差异大（如伯牙绝弦在青岛偏弱），可针对性本地化推广。
...
| **联动筛选 / 时间维度切片** | 城市 / 品类 / 月份三维联动筛选，所有图表与结论实时刷新；地图点击城市联动全看板 |
